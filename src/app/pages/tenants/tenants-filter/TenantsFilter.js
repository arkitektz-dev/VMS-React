...
const TenantsFilter = () => {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(tenantsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, tenantsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      tenantsUIProps.setQueryParams(newQueryParams);
    }
  };
