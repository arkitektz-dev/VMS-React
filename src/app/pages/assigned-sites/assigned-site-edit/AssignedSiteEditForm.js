...
// Validation schema
const AssignedSiteEditSchema = Yup.object().shape({
...
function AssignedSiteEditForm({ assignedSite, btnRef, updateAssignedSite }) {
  ...
  return (
    <>
      <Formik
        ...
        validationSchema={AssignedSiteEditSchema}
        onSubmit={(values) => {
          updateAssignedSite(values);
        }}
      >
        {({ values, handleSubmit }) => (
          <>
...
export default AssignedSiteEditForm;
